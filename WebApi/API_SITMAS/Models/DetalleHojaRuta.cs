...
namespace API_SITMAS.Models
{
    public class DetalleHojaRuta
    {
        ...
        // 🗺️ Propiedades Geográficas 
        public decimal? Latitud { get; set; }
        public decimal? Longitud { get; set; }

        // 📏 NUEVA PROPIEDAD: Distancia desde el punto anterior
        public decimal DistanciaDesdeAnterior_Km { get; set; }

        // Propiedades de lectura/descriptivas
                ...
                using (SqlDataReader reader = sqlCom.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        lista.Add(new DetalleHojaRuta
                        {
                            ...
                            // 📏 Leemos la distancia
                            DistanciaDesdeAnterior_Km = reader["DistanciaDesdeAnterior_Km"] != DBNull.Value ? Convert.ToDecimal(reader["DistanciaDesdeAnterior_Km"]) : 0m,
        ...
        /// <summary>
        /// Inserta una nueva parada/detalle en la Hoja de Ruta.
        /// </summary>
        public int Insertar()
        {
            using (SqlConnection sqlCnn = new SqlConnection(connectionString))
            using (SqlCommand sqlCom = new SqlCommand("sp_InsertarDetalleHDR", sqlCnn))
            {
                ...
                sqlCom.Parameters.AddWithValue("@DistanciaDesdeAnterior_Km", DistanciaDesdeAnterior_Km);
        ...
        /// <summary>
        /// Elimina físicamente una parada.
        /// </summary>
        public bool Borrar()
        {
            using (SqlConnection sqlCnn = new SqlConnection(connectionString))
