...
// function EliminarHojaRuta(id) {
//     // Usamos el modal interactivo de confirmación
//     confirmarAccion(
//         "¿Eliminar Hoja de Ruta?",
//         `⚠️ Se borrará la Hoja de Ruta #${id} junto con todas sus paradas asociadas. Esta acción no se puede deshacer.`,
//         function () {
//             // Ejecutamos el DELETE AJAX sólo si el usuario confirma en el modal
//             $.ajax({
//                 type: "DELETE",
//                 url: `${URL_API_HDR}/${id}`,
//                 dataType: "json",
